...
public class Ode implements EntryPoint {
  ...
  private ResearchToolsDialog researchToolsDialog;
  ...
  /**
   * Returns the research tools dialogue.
   *
   * @return  research tools window
   */
  public ResearchToolsDialog getResearchToolsDialog() {
    return researchToolsDialog;
  }
...
//    mainPanel.add(switchToBlocksButton, DockPanel.EAST);
    ...
    researchToolsDialog = new ResearchToolsDialog();
  }
